...
{
    public partial class ReceiverDomesticCompensate
    {
        public string ReceiverDomesticCompensateCode { get; set; }
        ...
        public virtual DomesticCompensateRule DomesticCompensateRule { get; set; }
    }
}
